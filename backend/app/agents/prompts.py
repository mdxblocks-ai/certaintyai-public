"""System prompts for InsightsGenerationAgent and NarrativeAgent (Phase 1.5.2).

Phase 1.5.2 — Removed all competitor mentions (Palantir, etc.). The
differentiation paragraph now focuses purely on CertaintyAI's value
proposition. Narrative sections kept at 80-120 words each (punchy).
"""
